    ...
    switch (button)
    {
        ...
        case 10:
            if (state == 1)
            {
                if (last_note[1] == 0)
                {
                    play_chord(button_to_note(1), button_to_chord_type(1));
                    last_chord[2] = 1;
                }
                else
                {
                    play_chord(button_to_note(last_note[1]), button_to_chord_type(last_note[1]));
                    last_chord[2] = last_note[1]; //bloop
                }
            }
            else
            {
...
void play_riff()
{
    if (beat_count % riff_timing[0] == 0)
    {
        ...
        {            
            ...
            {
                if(last_note[1] == 0 && mutes[2] == 0)
                {
                    play_note(note, riff_channel);  
                }
                if (bass_mode == 0 && mutes[3] == 0)
                {
